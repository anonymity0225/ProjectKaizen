"""
Django settings for weblogic project.
...
SECRET_KEY = 'django-insecure-4*ew0wa49(7%i$t6%zyo+3cp2@w@htuh%#b)4jp*f5ap!w8!*7'
...
WSGI_APPLICATION = 'weblogic.wsgi.application'
